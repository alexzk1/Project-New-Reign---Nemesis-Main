...
//    {
//        m_slotID = TlsAlloc();
//        HK_ON_DEBUG( if (m_slotID == HK_WIN32_TLS_INVALID)
//    {
//        HK_BREAKPOINT(0xabba3651);
//        } )
//    }
//    ~hkThreadLocalData()
//    {
...
#define HK_THREAD_LOCAL(TYPE) thread_local TYPE
